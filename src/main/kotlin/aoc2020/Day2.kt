...
fun runDay2() {
    val lines = File("files/2020/day2.txt").readLines()

    println("day2part1=${micros { day2part1(lines) }}")
    println("day2part2=${micros { day2part2(lines) }}")
}
...
fun day2part1(lines: List<String>): Int {
    ...
    for (l in lines) {
        val line = Line(l)
        val noChars = line.pw.count { c -> c == line.char }
