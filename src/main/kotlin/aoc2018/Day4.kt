...
class Day4 {
    fun guardIdMulByMinute(input: String): Int {
    ...
    fun guardMostFrequentlyAsleep(input: String):Int {
        val dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")
        val lines = input.lines()
            .map {
                LocalDateTime.parse(it.substring(it.indexOf("[") + 1, it.indexOf("]")), dtf) to it
    ...
    class Sleep(val guard: Int, val dayOfYear: Int, val from: Int) {
        var to: Int = -1
    ...
    @Test
    fun sample() {
        assertEquals(240, guardIdMulByMinute("[1518-11-01 00:00] Guard #10 begins shift\n" +
    ...
    @Test
    fun `part 2 sample`() {
        assertEquals(4455, guardMostFrequentlyAsleep("[1518-11-01 00:00] Guard #10 begins shift\n" +
                "[1518-11-01 00:05] falls asleep\n" +
                "[1518-11-01 00:25] wakes up\n" +
                "[1518-11-01 00:30] falls asleep\n" +
                "[1518-11-01 00:55] wakes up\n" +
